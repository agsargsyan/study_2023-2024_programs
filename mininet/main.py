...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(h1, r1, intfName2='r1-eth1', params2={'ip': '10.0.0.1/24'}, delay='5ms')
        self.addLink(h2, r2, intfName2='r2-eth1', params2={'ip': '10.1.0.1/24'}, delay='2ms')
...
def run():
    ...
    h1 = net.get('h1')
    h1.cmd('iperf3 -c', h2.IP(),'-t 25 -J > iperf3.json')
