...
def run_iperf(net, host1_name, host2_name):
    ...
    h1.cmd(f'iperf3 -c {h2.IP()} -w 16K -t 26 -J > output/{host1_name}_to_{host2_name}/{host1_name}_to_{host2_name}_iperf3.json')
...
def run(num_hosts_subnets=20):
    ...
    net['r0'].cmdPrint("tc qdisc add dev r0-eth2 root handle 1: red limit {} min {} max {} avpkt {} bandwidth {} probability {} burst {}".format(limit, min_, max_, avpkt, bandwidth, probability, burst))
